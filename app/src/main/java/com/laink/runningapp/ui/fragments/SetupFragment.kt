...
class SetupFragment : Fragment(R.layout.fragment_setup) {
    ...
    @set:Inject // Because we can't use "lateinit" for primitive types
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (!isFirstAppOpen) {
            // Pop up to a given destination before navigating (true - to also pop the given destination from the back stack)
    ...
    private fun writePersonalDateToSharedPreferences(): Boolean {
